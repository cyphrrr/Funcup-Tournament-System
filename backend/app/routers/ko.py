...
def get_ko_matches_batch(match_ids: str, db: Session = Depends(get_db)):
    ...
    for match in matches:
        home_team = teams.get(match.home_team_id, {}) if match.home_team_id else {}
        away_team = teams.get(match.away_team_id, {}) if match.away_team_id else {}
        result.append({
            "id": match.id,
            "home_team_id": match.home_team_id,
            "away_team_id": match.away_team_id,
            "home_team_name": home_team.get("name", f"Team {match.home_team_id}") if match.home_team_id else None,
            "home_team_logo": home_team.get("logo_url") if match.home_team_id else None,
            "away_team_name": away_team.get("name", f"Team {match.away_team_id}") if match.away_team_id else None,
            "away_team_logo": away_team.get("logo_url") if match.away_team_id else None,
